...
# Updated August 14, 2025 for tk gem 0.5.1 with uninstall cleanup on failure and retry fix
...
# Run the installer
TkInstaller::DynamicTkUtils.new.run            log "Found #{file} at: #{found_path}"
            file_found = true
            break
          end
        end
